...
export type AssetCreateInput = {
  ...
  blogLogoSetting?: InputMaybe<SettingCreateManyInlineInput>;
...
export type AssetManyWhereInput = {
  ...
  blogLogoSetting_every?: InputMaybe<SettingWhereInput>;
  blogLogoSetting_none?: InputMaybe<SettingWhereInput>;
  blogLogoSetting_some?: InputMaybe<SettingWhereInput>;
...
export type AssetUpdateInput = {
  ...
  blogLogoSetting?: InputMaybe<SettingUpdateManyInlineInput>;
...
export type CategoryCreateInput = {
  ...
  createdAt?: InputMaybe<Scalars['DateTime']>;
  name: Scalars['String'];
  posts?: InputMaybe<CategoryPostsCreateManyInlineInput>;
  slug: Scalars['String'];
  updatedAt?: InputMaybe<Scalars['DateTime']>;
};
...
export type CategoryPostsConnectInput = {
  Post?: InputMaybe<PostConnectInput>;
};

export type CategoryPostsCreateInput = {
  Post?: InputMaybe<PostCreateInput>;
};

export type CategoryPostsCreateManyInlineInput = {
  /** Connect multiple existing CategoryPosts documents */
  connect?: InputMaybe<Array<CategoryPostsWhereUniqueInput>>;
  /** Create and connect multiple existing CategoryPosts documents */
  create?: InputMaybe<Array<CategoryPostsCreateInput>>;
};

export type CategoryPostsCreateOneInlineInput = {
  /** Connect one existing CategoryPosts document */
  connect?: InputMaybe<CategoryPostsWhereUniqueInput>;
  /** Create and connect one CategoryPosts document */
  create?: InputMaybe<CategoryPostsCreateInput>;
};

export type CategoryPostsUpdateInput = {
  Post?: InputMaybe<PostUpdateInput>;
};

export type CategoryPostsUpdateManyInlineInput = {
  /** Connect multiple existing CategoryPosts documents */
  connect?: InputMaybe<Array<CategoryPostsConnectInput>>;
  /** Create and connect multiple CategoryPosts documents */
  create?: InputMaybe<Array<CategoryPostsCreateInput>>;
  /** Delete multiple CategoryPosts documents */
  delete?: InputMaybe<Array<CategoryPostsWhereUniqueInput>>;
  /** Disconnect multiple CategoryPosts documents */
  disconnect?: InputMaybe<Array<CategoryPostsWhereUniqueInput>>;
  /** Override currently-connected documents with multiple existing CategoryPosts documents */
  set?: InputMaybe<Array<CategoryPostsWhereUniqueInput>>;
  /** Update multiple CategoryPosts documents */
  update?: InputMaybe<Array<CategoryPostsUpdateWithNestedWhereUniqueInput>>;
  /** Upsert multiple CategoryPosts documents */
  upsert?: InputMaybe<Array<CategoryPostsUpsertWithNestedWhereUniqueInput>>;
};

export type CategoryPostsUpdateManyWithNestedWhereInput = {
  Post?: InputMaybe<PostUpdateManyWithNestedWhereInput>;
};

export type CategoryPostsUpdateOneInlineInput = {
  ...
  update?: InputMaybe<CategoryPostsUpdateWithNestedWhereUniqueInput>;
  /** Upsert single CategoryPosts document */
  upsert?: InputMaybe<CategoryPostsUpsertWithNestedWhereUniqueInput>;
};

export type CategoryPostsUpdateWithNestedWhereUniqueInput = {
  Post?: InputMaybe<PostUpdateWithNestedWhereUniqueInput>;
};

export type CategoryPostsUpsertWithNestedWhereUniqueInput = {
  Post?: InputMaybe<PostUpsertWithNestedWhereUniqueInput>;
};

export type CategoryPostsWhereInput = {
  Post?: InputMaybe<PostWhereInput>;
};

export type CategoryPostsWhereUniqueInput = {
...
export type CategoryUpdateInput = {
  ...
  name?: InputMaybe<Scalars['String']>;
  posts?: InputMaybe<CategoryPostsUpdateManyInlineInput>;
  slug?: InputMaybe<Scalars['String']>;
};
...
export type CreatorCreateWithPositionInput = {
  /** Document to create */
...
export type CreatorUpdateInput = {
  ...
  name?: InputMaybe<Scalars['String']>;
  picture?: InputMaybe<AssetUpdateOneInlineInput>;
  resume?: InputMaybe<Scalars['RichTextAST']>;
};

export type CreatorUpdateManyInlineInput = {
  /** Create and connect multiple Creator component instances */
  create?: InputMaybe<Array<CreatorCreateWithPositionInput>>;
  /** Delete multiple Creator documents */
  delete?: InputMaybe<Array<CreatorWhereUniqueInput>>;
  /** Update multiple Creator component instances */
  update?: InputMaybe<Array<CreatorUpdateWithNestedWhereUniqueAndPositionInput>>;
  /** Upsert multiple Creator component instances */
  upsert?: InputMaybe<Array<CreatorUpsertWithNestedWhereUniqueAndPositionInput>>;
};
...
export type CreatorUpdateWithNestedWhereUniqueAndPositionInput = {
  /** Document to update */
  data?: InputMaybe<CreatorUpdateInput>;
  /** Position in the list of existing component instances, will default to appending at the end of list */
  position?: InputMaybe<ConnectPositionInput>;
...
export type CreatorUpsertWithNestedWhereUniqueAndPositionInput = {
  /** Document to upsert */
  data?: InputMaybe<CreatorUpsertInput>;
  /** Position in the list of existing component instances, will default to appending at the end of list */
  position?: InputMaybe<ConnectPositionInput>;
  /** Unique component instance search */
  where: CreatorWhereUniqueInput;
...
export enum PostOrderByInput {
  AllowCommentsAsc = 'allowComments_ASC',
  AllowCommentsDesc = 'allowComments_DESC',
  CreatedAtAsc = 'createdAt_ASC',
  CreatedAtDesc = 'createdAt_DESC',
  DateAsc = 'date_ASC',
  DateDesc = 'date_DESC',
...
export type SettingManyWhereInput = {
  ...
  /** All values that are contained in given list. */
  blogDescription_in?: InputMaybe<Array<Scalars['String']>>;
  /** All values that are not equal to given value. */
  ...
  /** All values that are not contained in given list. */
  blogDescription_not_in?: InputMaybe<Array<Scalars['String']>>;
  /** All values not starting with the given string. */
  blogDescription_not_starts_with?: InputMaybe<Scalars['String']>;
  /** All values starting with the given string. */
  blogDescription_starts_with?: InputMaybe<Scalars['String']>;
  blogLogo?: InputMaybe<AssetWhereInput>;
  blogName?: InputMaybe<Scalars['String']>;
  /** All values containing the given string. */
  blogName_contains?: InputMaybe<Scalars['String']>;
  /** All values ending with the given string. */
  blogName_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are contained in given list. */
  blogName_in?: InputMaybe<Array<Scalars['String']>>;
  /** All values that are not equal to given value. */
  blogName_not?: InputMaybe<Scalars['String']>;
  /** All values not containing the given string. */
  blogName_not_contains?: InputMaybe<Scalars['String']>;
  /** All values not ending with the given string */
  blogName_not_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are not contained in given list. */
  blogName_not_in?: InputMaybe<Array<Scalars['String']>>;
  /** All values not starting with the given string. */
  blogName_not_starts_with?: InputMaybe<Scalars['String']>;
  /** All values starting with the given string. */
  blogName_starts_with?: InputMaybe<Scalars['String']>;
  createdAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
  createdAt_gt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than or equal the given value. */
...
export type TagCreateInput = {
  createdAt?: InputMaybe<Scalars['DateTime']>;
  name: Scalars['String'];
  posts?: InputMaybe<TagPostsCreateManyInlineInput>;
  slug: Scalars['String'];
  updatedAt?: InputMaybe<Scalars['DateTime']>;
};
...
export type TagPostsConnectInput = {
  Post?: InputMaybe<PostConnectInput>;
};

export type TagPostsCreateInput = {
  Post?: InputMaybe<PostCreateInput>;
};

export type TagPostsCreateManyInlineInput = {
  /** Connect multiple existing TagPosts documents */
  connect?: InputMaybe<Array<TagPostsWhereUniqueInput>>;
  /** Create and connect multiple existing TagPosts documents */
  create?: InputMaybe<Array<TagPostsCreateInput>>;
};

export type TagPostsCreateOneInlineInput = {
  /** Connect one existing TagPosts document */
  connect?: InputMaybe<TagPostsWhereUniqueInput>;
  /** Create and connect one TagPosts document */
  create?: InputMaybe<TagPostsCreateInput>;
};

export type TagPostsUpdateInput = {
  Post?: InputMaybe<PostUpdateInput>;
};

export type TagPostsUpdateManyInlineInput = {
  /** Connect multiple existing TagPosts documents */
  connect?: InputMaybe<Array<TagPostsConnectInput>>;
  /** Create and connect multiple TagPosts documents */
  create?: InputMaybe<Array<TagPostsCreateInput>>;
  /** Delete multiple TagPosts documents */
  delete?: InputMaybe<Array<TagPostsWhereUniqueInput>>;
  /** Disconnect multiple TagPosts documents */
  disconnect?: InputMaybe<Array<TagPostsWhereUniqueInput>>;
  /** Override currently-connected documents with multiple existing TagPosts documents */
  set?: InputMaybe<Array<TagPostsWhereUniqueInput>>;
  /** Update multiple TagPosts documents */
  update?: InputMaybe<Array<TagPostsUpdateWithNestedWhereUniqueInput>>;
  /** Upsert multiple TagPosts documents */
  upsert?: InputMaybe<Array<TagPostsUpsertWithNestedWhereUniqueInput>>;
};

export type TagPostsUpdateManyWithNestedWhereInput = {
  Post?: InputMaybe<PostUpdateManyWithNestedWhereInput>;
};

export type TagPostsUpdateOneInlineInput = {
  /** Connect existing TagPosts document */
  connect?: InputMaybe<TagPostsWhereUniqueInput>;
  /** Create and connect one TagPosts document */
  create?: InputMaybe<TagPostsCreateInput>;
  /** Delete currently connected TagPosts document */
  delete?: InputMaybe<Scalars['Boolean']>;
  /** Disconnect currently connected TagPosts document */
  disconnect?: InputMaybe<Scalars['Boolean']>;
  /** Update single TagPosts document */
  update?: InputMaybe<TagPostsUpdateWithNestedWhereUniqueInput>;
  /** Upsert single TagPosts document */
  upsert?: InputMaybe<TagPostsUpsertWithNestedWhereUniqueInput>;
};

export type TagPostsUpdateWithNestedWhereUniqueInput = {
  Post?: InputMaybe<PostUpdateWithNestedWhereUniqueInput>;
};

export type TagPostsUpsertWithNestedWhereUniqueInput = {
  Post?: InputMaybe<PostUpsertWithNestedWhereUniqueInput>;
};

export type TagPostsWhereInput = {
  Post?: InputMaybe<PostWhereInput>;
};

export type TagPostsWhereUniqueInput = {
  Post?: InputMaybe<PostWhereUniqueInput>;
};

export type TagUpdateInput = {
  name?: InputMaybe<Scalars['String']>;
  posts?: InputMaybe<TagPostsUpdateManyInlineInput>;
  slug?: InputMaybe<Scalars['String']>;
};
